[IMG]https://i.postimg.cc/FKKnJybw/EXNDEX-BANNER.png[/IMG]
[CENTER][B][SIZE=6]The Endex | Dynamic Market & Addons [1.20.1 - 1.21.8][/SIZE][/B]
[I]Dynamic, demand-driven market with GUI, events, and Vault economy[/I][/CENTER]
...
[B]Support[/B]
For questions, feedback, or issue reports, please use the resource discussion and include the output of [ICODE]/endex version[/ICODE] along with any relevant logs.
