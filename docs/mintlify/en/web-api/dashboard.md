...
The dashboard includes built-in Google Translate integration for **26+ languages**:

- English, Chinese, Spanish, French, German, Japanese, Korean, Portuguese, Russian
- Italian, Thai, Vietnamese, Indonesian, Turkish, Polish, Dutch, Swedish
- Danish, Finnish, Czech, Romanian, Ukrainian, Hindi, Bengali, Tagalog, Arabic

<Tip>
Use the language dropdown in the header (between your player name and the theme toggle) to switch languages.
</Tip>

The translation widget is styled to match the dashboard's dark theme.
