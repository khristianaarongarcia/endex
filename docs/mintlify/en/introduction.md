...
## What's New in 1.5.7-dec1022

- **Web Dashboard Translation** — Google Translate integration for 26+ languages
- **GUI Fix** — Fixed ArrayIndexOutOfBoundsException in market details panel
- **Performance Indicators** — Config options now show `[PERF: LOW/MEDIUM/HIGH]` tags
- **Translated Configs** — Pre-translated config files in 9 languages
- **Sell from Holdings** — Sell items directly from virtual holdings (1.5.7)
- **In-Game Layout Editor** — Visual GUI editor for custom shop layouts (1.5.6)
- **Arclight Support** — Full compatibility with hybrid servers (1.5.7)
