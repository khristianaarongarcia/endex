...
- **Live item pricing** that moves based on supply and demand
- **Holdings** (virtual storage) so players can trade without inventory juggling
...
| World Storage Scanning | Prices can react to stored items (optional) |
